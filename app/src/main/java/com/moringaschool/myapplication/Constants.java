...
public class Constants {
    ...
    public static final String PREFERENCES_LOCATION_KEY = "location";//reusable key for the location preference
    public static final String FIREBASE_CHILD_SEARCHED_LOCATION = "searchedLocation";//defined account
